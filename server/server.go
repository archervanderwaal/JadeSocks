...
import (
	...
	"github.com/archervanderwaal/JadeSocks/core"
...
func (server *Server) Listen(listenHandler func(listenAddr *net.TCPAddr)) error {
	return JadeSocks.ListenEncryptedTCP(server.ListenAddr, server.Cipher, server.handleConn, listenHandler)
}

// 解 SOCKS5 协议
// https://www.ietf.org/rfc/rfc1928.txt
func (server *Server) handleConn(localConn *JadeSocks.SecureTCPConn) {
